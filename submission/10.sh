...
bitcoin-cli -regtest -rpcwallet=btrustwallet validateaddress "bcrt1qckgvfee4qs6y98jrcn8qc0m6ce6sxls0vac3yy" | python3 -c "import sys,json; print(json.load(sys.stdin)['isvalid'])" | tr '[:upper:]' '[:lower:]'